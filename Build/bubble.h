...
#define BMC_ST_READY		0x08		/* メディア挿入 */
#define BMC_ST_NONE			0x10		/* 常に'1' */
...
#define BMC_ACCESS_NOTREADY	3			/* ユニットの準備ができていない */
#define BMC_ACCESS_TEJECT	4			/* ユニットが一時イジェクト中 */
#define BMC_LOST_TIME		300			/* wait時のLOST DATAまでの時間 */
