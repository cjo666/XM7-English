...
#define	EVENT_KEYENC_BEEP		23		/* キーエンコーダBEEP 単音タイマ */
#define	EVENT_KEYENC_MESSAGE	24		/* キーエンコーダ 隠しメッセージ */
#define	EVENT_PTM_TIMER			25		/* PTMタイマ */
#define	EVENT_BMC_LOST			26		/* バブルメモリ ロストデータ */
#define	EVENT_BMC_MULTI			27		/* バブルメモリ マルチページ */
