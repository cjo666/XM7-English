...
char lp_fname[256+1];					/* プリンタ ファイルネーム */

/*
 *	スタティック ワーク
 */
static BYTE lp_openuse;						/* プリンタ OPEN時の使用モード */
